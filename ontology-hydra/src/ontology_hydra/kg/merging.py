...
def try_merge(
    ...
    for name in all_names:
        ...
        entity_type = cast(
            "type[DynamicPartialEntity]",
            a_entity.__class__ if a_entity is not None else b_entity.__class__,
        ...
        d = {
            "name": name,
            "cls": class_name,
            **{k: _merge_values(a_json.get(k), b_json.get(k)) for k in all_keys},
        }
