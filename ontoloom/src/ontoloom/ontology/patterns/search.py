...
from ontoloom.ontology.models.base import WALKER_SKIP, BasePattern
from ontoloom.ontology.models.expressions import ClassExpression
from ontoloom.ontology.models.literals import IRI
from ontoloom.ontology.patterns import ExpressionPattern
...
def match_axioms(
    ...
    *,
    ...
    for h, json_data in _iter_candidates(ont, pattern, within):
        axiom = load_axiom(json_data, f"match {truncate_hash(h)}")
