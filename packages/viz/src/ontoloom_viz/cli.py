"""CLI entry point for ontoloom-viz server."""
...
from ontoloom_viz.app import create_app


def _parse_args():
    parser = argparse.ArgumentParser(
        prog="ontoloom-viz",
        description="Web visualization server for ontoloom runs",
    )
    parser.add_argument(
        "runs_dir",
        type=Path,
...
def main():
    """Main entry point for the ontoloom-viz CLI."""
    args = _parse_args()
